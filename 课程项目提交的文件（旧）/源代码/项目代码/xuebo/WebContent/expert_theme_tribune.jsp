...
<body>
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <img alt="Bootstrap Image Preview" class="rounded-circle" src="${expert.expertimage }" style="position: relative;margin-left: 230px; margin-top: -70px; width:140px;height:140px;" />
                <div class="row">
                                            ...
                                            <div class="modal-dialog" role="document" style="position: relative;margin-top: 80px;">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form role="form" action="PublishDiscussAction?id=${cookie.xueboExpertName.value }&tribuneid=${tribune.tribuneid}&type=1&state=2" method="post">                                                            
                                ...
                                <div aria-hidden="true" aria-labelledby="myModalLabel" class="modal fade" id="modal-container-817140" role="dialog">
                                    <div class="modal-dialog" role="document" style="position: relative;margin-top: 80px;">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form role="form" action="CreateTribuneActionForExpert?expertid=${cookie.xueboExpertName.value }" method="post">
                                                <div class="form-group">
                                        ...
                                        <div aria-hidden="true" aria-labelledby="myModalLabel" class="modal fade" id="modal-container-${tribune.tribuneid}817141" role="dialog">
                                            <div class="modal-dialog" role="document" style="position: relative;margin-top: 80px;">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form role="form" action="DelectTribuneAction?tribuneid=${tribune.tribuneid}&id=${tribune.expertid }&creatorstate=${tribune.creatorstate }" method="post">
                                                            <div class="form-group">
