...
/**
 * Servlet implementation class ScreenFirstoptionListActionForPrice
 */
public class ScreenFirstoptionListActionForPrice extends HttpServlet {
     ...
     */
    public ScreenFirstoptionListActionForPrice() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		books = bookController.BookScreenPriceExpertListForStudent();
