...
/**
 * Servlet implementation class ShowFirstoptionListAction
 */
public class ShowFirstoptionListAction extends HttpServlet {
     ...
     */
    public ShowFirstoptionListAction() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		books = bookController.BookShowExpertListForStudent();
