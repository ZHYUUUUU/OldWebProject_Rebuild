...
/**
 * Servlet implementation class ScreenFirstoptionListActionForPoint
 */
public class ScreenFirstoptionListActionForPoint extends HttpServlet {
     ...
     */
    public ScreenFirstoptionListActionForPoint() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		books = bookController.BookScreenPointExpertListForStudent();
